...
import com.zerobase.stockdividendproject.Type.Month;
...
import static com.zerobase.stockdividendproject.Type.ErrorCode.UNEXPECTED_MONTH;
...
public class YahooFinanceScraper implements Scraper {
    ...
    public ScrapedResult scrap(CompanyDto companyDto) {
        ...
        scarpResult.setCompanyDto(companyDto);

        try {
            long now = System.currentTimeMillis() / 1000;

            String url = String.format(STATICS_URL, companyDto.getTicker(), START_TIME, now);
...
//                    throw new RuntimeException("Unexpected Month enum value -> " + splits[0]);
                    ...
                    log.error("Unexpected Month enum value -> " + splits[0]);
                    throw new StockDividendException(UNEXPECTED_MONTH);
                }

                dividends.add(new DividendDto(LocalDateTime.of(year, month, day, 0, 0), dividend)
//                        Dividend.builder()
